...
<h5 class="fw-bold"><i class="bi text-secondary me-2"></i>Categorias</h5>
...
window.onload = function(){
    ...
    let tabla = $('#tabla').DataTable({
        ajax:'/contable/ajax/categorias.php?accion=listar',
        columns:[
            {data:'id'},
            {data:'nombre'},
            {
    ...
    document.getElementById('form').addEventListener('submit', function(e){
        ...
        $.post('/contable/ajax/categorias.php?accion=guardar', $(this).serialize(), function(){
            tabla.ajax.reload();
    ...
    window.eliminar = function(id){
        ...
        $.post('/contable/ajax/categorias.php?accion=eliminar', {id:id}, function(){
            tabla.ajax.reload();
        });
    }
